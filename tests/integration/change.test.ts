...
import prCommand from "@/commands/change";
...
describe("integration > pr commands", () => {
  ...
  it("push calls service with parsed pr number and force", async () => {
    ...
    await program.parseAsync(["node", "test", "change", "push", "42", "-f"]);
  ...
  it("stack list calls service", async () => {
    ...
    await program.parseAsync(["node", "test", "change", "stack", "list"]);
  ...
  it("stack update calls service", async () => {
    ...
    await program.parseAsync(["node", "test", "change", "stack", "update"]);
