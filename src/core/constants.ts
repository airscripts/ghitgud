...
export const ERROR_NO_REPO = "You must set the GHITGUD_GITHUB_REPO environment variable.";
export const ERROR_NO_TOKEN = "You must set the GHITGUD_GITHUB_TOKEN environment variable.";
