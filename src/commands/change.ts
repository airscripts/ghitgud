...
import { ERROR_CHANGE_NUMBER_REQUIRED } from "@/core/constants";

const register = (program: Command) => {
  const pr = program
    .command("change")
    .description("Manage proposed changes for a repository.");
...
Examples:
  ...
  gitfleet change checks 42
  gitfleet change merge 42 --squash --delete-branch
  gitfleet change cleanup --dry-run
  gitfleet change push 42
