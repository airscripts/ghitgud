...
const register = (program: Command) => {
  const repos = program
    .command("govern")
    .description("Inspect and govern repository fleets.");

  repos.addHelpText(
    "after",
    `
Examples:
  gitfleet govern inspect --org airscripts
  gitfleet govern clone --user octocat
  gitfleet govern report --repos owner/one,owner/two
`,
  );
