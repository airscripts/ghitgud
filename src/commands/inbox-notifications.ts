...
const register = (program: Command) => {
  const notifications = commandGroup(
    program,
    "inbox",
    "Manage notifications, activity, mentions, and review requests.",
  )
    .command("notifications")
    .description("Manage provider notifications.");

  notifications.addHelpText(
    "after",
    `
Examples:
  gitfleet inbox notifications list
  gitfleet inbox notifications list --repo owner/repo
  gitfleet inbox notifications list --org my-org
  gitfleet inbox notifications read 12345
`,
  );
  ...
  addTargetOptions(
    notifications
      ...
      .addHelpText(
        ...
        `
Examples:
  gitfleet inbox notifications list-by-target --org my-org
  gitfleet inbox notifications list-by-target --repos owner/repo1,owner/repo2
`,
      ),
  )
    .option("-a, --all", "Include read notifications")
