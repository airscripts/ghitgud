...
const projectOperations: TuiOperation[] = [
  ...
  ),
  {
    ...
    command: "ghg project item-list <id>",
  ...
  },
  {
    ...
    command: "ghg project item-add <id>",
  ...
  },
  {
    ...
    command: "ghg project item-create <id>",
  ...
  },
  {
    ...
    command: "ghg project field-list <id>",
  ...
  ...[true, false].map(
    (linked): TuiOperation => ({
      ...
      command: `ghg project ${linked ? "link" : "unlink"} <id>`,
