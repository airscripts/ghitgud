...
const runOperations: TuiOperation[] = [
  ...
  ...[
    ...
    ([action, serviceAction, title]): TuiOperation => ({
      ...
      id: `run.${action}`,
      description: `${title}.`,
      command: `gitfleet run ${action} <run-id>`,
...

  {
    ...
    command: "gitfleet run rerun <run-id>",
...

  {
    ...
    command: "gitfleet run download <run-id>",
...

  {
    ...
    id: "run.watch",
    title: "Watch Run",
    command: "gitfleet run watch <run-id>",
...

  {
    ...
    command: "gitfleet run debug <run-id>",
