...
const teamOperations: TuiOperation[] = [
  {
    ...
    workspace: "Team",
    title: "List Teams",
    command: "gitfleet team list --org \u003corg\u003e",
...

  {
    ...
    command:
      "gitfleet team create --org \u003corg\u003e --name \u003cname\u003e",
...

  {
    ...
    command:
      "gitfleet team add --org \u003corg\u003e --team \u003cteam\u003e --user \u003cuser\u003e --role \u003crole\u003e",
...

  {
    ...
    command:
      "gitfleet team remove --org \u003corg\u003e --team \u003cteam\u003e --user \u003cuser\u003e",
