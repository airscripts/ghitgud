...
const workflowOperations: TuiOperation[] = [
  {
    ...
    command: "gitfleet workflow list",
  ...
  },
  {
    ...
    id: "workflow.view",
    title: "View Workflow",
    command: "gitfleet workflow view <name-or-id>",
  ...
  },
  {
    ...
    id: "workflow.run",
    title: "Run Workflow",
    command: "gitfleet workflow run <name-or-id>",
  ...
  ...[true, false].map(
    (enabled): TuiOperation => ({
      ...
      command: `gitfleet workflow ${enabled ? "enable" : "disable"} <name-or-id>`,
  ...
  ),
  {
    ...
    command: "gitfleet workflow validate",
    description: "Validate pipeline workflow files.",
...

  {
    ...
    command: "gitfleet workflow preview",
    description: "Preview pipeline workflow structure.",
    inputs: [{ key: "path", label: "Path", type: "string" }],
