...
const notificationOperations: TuiOperation[] = [
  {
    ...
    command: "gitfleet notifications list",
    description: "List provider notifications.",
...

  {
    ...
    command: "gitfleet notifications list --repo <targets>",
...

  {
    ...
    command: "gitfleet notifications read <id>",
...

  {
    ...
    command: "gitfleet notifications done <id>",
